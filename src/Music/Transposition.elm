...
type alias TranspositionState = 
  ...
  , targetBarAccidentals : Accidentals -- ditto for the tune target
  }
...
transposeNote targetKey srcKey note =
  ...
  in
    case rdist of
      ...
      Ok d  -> 
        let
          transpositionState = { keyDistance = d, srcmks = srcKey, sourceBarAccidentals = Music.Accidentals.empty, targetBarAccidentals = Music.Accidentals.empty}
    ...
    case rdistance of
      ...
      Ok d ->
        ...
        if (d == 0) then
          ...
          let
            transpositionState = { keyDistance = d, srcmks = mks, sourceBarAccidentals = Music.Accidentals.empty, targetBarAccidentals = Music.Accidentals.empty }
          in
